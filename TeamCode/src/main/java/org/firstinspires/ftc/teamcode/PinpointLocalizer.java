...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1688.0897730910717; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1793.6596448687799; // x position of the perpendicular encoder (in tick units)
    }
